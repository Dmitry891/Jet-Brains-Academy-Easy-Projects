...
public class CinemaRoomManager {
    ...
    private static void displayMenu(int choice, String[][] cinema, int numRows, int numSeats) {
        Scanner scanner = new Scanner(System.in);
        while (choice != 0) {
            switch (choice) {
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    displayStatistics(cinema, numRows, numSeats);
                    break;
                default:
                    break;
            }
    ...
    private static void displayStatistics(String[][] cinema, int numRows, int numSeats) {
        int totalIncome = 0;
